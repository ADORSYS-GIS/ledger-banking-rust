...
impl CollateralMapper {
    ...
    pub fn to_model(collateral: Collateral) -> CollateralModel {
        CollateralModel {
            ...
            custodian_details_id: collateral.custodian_details_id,
            legal_title_holder_person_id: collateral.legal_title_holder_person_id,
            ...
            registration_authority_person_id: collateral.registration_authority_person_id,
            ...
            last_valuation_by_person_id: collateral.last_valuation_by_person_id,
    ...
    pub fn from_model(model: CollateralModel) -> banking_api::BankingResult<Collateral> {
        Ok(Collateral {
            ...
            last_valuation_by_person_id: model.last_valuation_by_person_id,
    ...
    pub fn alert_from_model(model: CollateralAlertModel) -> banking_api::BankingResult<CollateralAlert> {
        Ok(CollateralAlert {
            ...
            resolved_by_person_id: model.resolved_by_person_id,
        })
    }
